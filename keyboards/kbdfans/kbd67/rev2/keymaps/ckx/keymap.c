...
/* Keymap (Base Layer) Default Layer
   * ,----------------------------------------------------------------.
   * |Esc|  1|  2|  3|  4|  5|  6|  7|  8|  9|  0|  -|  =|^ | jpy | Bksp |Ins|
   * |----------------------------------------------------------------|
   * |Tab  |  Q|  W|  E|  R|  T|  Y|  U|  I|  O|  P|  [|  ]|  \  |Del|
   * |----------------------------------------------------------------|
   * |大文字 |  A|  S|  D|  F|  G|  H|  J|  K|  L|  ;| : |Return |PgUp|
   * |----------------------------------------------------------------|
   * |Shift   |  Z|  X|  C|  V|  B|  N|  M|  ,|  .|  /|Shift | Up|PgDwn |
   * |----------------------------------------------------------------|
   * |Ctrl|Win |Alt |  Space     | Fn1 | Fn2 | Fn3 | Ldr  |Lef|Dow|Rig |
   * `----------------------------------------------------------------'
   */
...
[0] = LAYOUT_all(
  ...
  KC_LSFT, KC_NO, KC_Z, KC_X, KC_C, KC_V, KC_B, JP_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, MO(1), KC_UP, KC_PGDN,\
...
[2] = LAYOUT_all(
  ...
  DYN_REC_STOP, KC_NO, DYN_REC_START1, DYN_MACRO_PLAY1, DYN_REC_START2, DYN_MACRO_PLAY2, KC_B, KC_N, KC_M, KC_LABK, KC_RABK, KC_QUES, KC_RSFT, KC_VOLU, KC_MPLY,\
  KC_LCTL, KC_LGUI, KC_LALT, KC_SPC, MO(2), KC_LSFT, MO(3), KC_NO, KC_LEAD, KC_MPRV, KC_VOLD, KC_MNXT),
